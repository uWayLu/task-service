...
這個資料夾用來存放您的待辦事項和需求文件，供 AI 解析與實現。
...
當您要求 AI 處理待辦事項時，可以這樣說：

- "請讀取 todo/active/ 中的待辦事項並實現"
- "檢查 todo 資料夾，看有什麼要做的"
- "實現 todo/active/feature_x.md 中的功能"
- "檢視所有未完成的待辦事項並排優先順序"
...
1. **複製範本**
   ```bash
   cp todo/template.md todo/active/my_new_feature.md
   ```
...
3. **請 AI 實現**
   ```
   "請實現 todo/active/my_new_feature.md 中的功能"
   ```

4. **完成後移動**
   ```bash
   mv todo/active/my_new_feature.md todo/completed/
   ```
