...
```bash
cp requirements/template.md requirements/active/my_feature.md
# 編輯 my_feature.md
```
...
- "請讀取 requirements/active/ 中的需求並實現"
- "檢查需求資料夾，看有什麼要做的"
- "實現 requirements/active/feature_x.md 中的功能"
- "檢視所有未完成的需求並排優先順序"
...
1. **複製範本**
   ```bash
   cp requirements/template.md requirements/active/my_new_feature.md
   ```
...
3. **請 AI 實現**
   ```
   "請實現 requirements/active/my_new_feature.md 中的功能"
   ```

4. **完成後移動**
   ```bash
   mv requirements/active/my_new_feature.md requirements/completed/
   ```
